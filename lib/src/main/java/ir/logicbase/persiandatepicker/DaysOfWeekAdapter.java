...
class DaysOfWeekAdapter extends BaseAdapter {
    ...
    private static final int CALENDAR_DAY_STYLE = VERSION.SDK_INT >= VERSION_CODES.O ? NARROW_FORMAT : Calendar.SHORT;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        int dayOfWeekPosition = positionToDayOfWeek(position);
        String[] dayOfWeekLetters = parent.getContext().getResources().getStringArray(R.array.pdp_day_of_week_letters);
        dayOfWeek.setText(dayOfWeekLetters[dayOfWeekPosition - 1]);
