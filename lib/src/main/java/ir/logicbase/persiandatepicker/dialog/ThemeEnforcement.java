...
package ir.logicbase.persiandatepicker.dialog;
...
public final class ThemeEnforcement {
   ...
   *
   * <p>Set a component's {@link com.google.android.material.R.attr#enforceMaterialTheme enforceMaterialTheme} attribute to
   * <code>true</code> to ensure that the Context's theme inherits from {@link
   * com.google.android.material.R.style#Theme_MaterialComponents Theme.MaterialComponents}. For example, you'll want to do this
   * if the component uses a new attribute defined in <code>Theme.MaterialComponents</code> like
   * {@link com.google.android.material.R.attr#colorSecondary colorSecondary}.
   *
   * <p>If {@link com.google.android.material.R.attr#enforceTextAppearance} attribute is set to <code>true</code> and
  ...
  private static void checkCompatibleTheme(
    ...
    TypedArray a =
        context.obtainStyledAttributes(
            set, com.google.android.material.R.styleable.ThemeEnforcement, defStyleAttr, defStyleRes);
    boolean enforceMaterialTheme =
        a.getBoolean(com.google.android.material.R.styleable.ThemeEnforcement_enforceMaterialTheme, false);
    a.recycle();

    if (enforceMaterialTheme) {
      TypedValue isMaterialTheme = new TypedValue();
      boolean resolvedValue =
          context.getTheme().resolveAttribute(com.google.android.material.R.attr.isMaterialTheme, isMaterialTheme, true);
  ...
  private static void checkTextAppearance(
    ...
    boolean enforceTextAppearance =
        themeEnforcementAttrs.getBoolean(com.google.android.material.R.styleable.ThemeEnforcement_enforceTextAppearance, false);
    ...
    if (textAppearanceResIndices == null || textAppearanceResIndices.length == 0) {
      ...
      validTextAppearance =
          themeEnforcementAttrs.getResourceId(
                  com.google.android.material.R.styleable.ThemeEnforcement_android_textAppearance, -1)
              != -1;
    } else {
