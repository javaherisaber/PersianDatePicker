...
public final class MaterialDatePicker<S> extends DialogFragment {
     ...
     */
    public static long firstDayOfMonthInUtcMilliseconds() {
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        int surfaceColor = MaterialAttributes.resolveOrThrow(
    ...
    public final View onCreateView(
        ...
        ChipGroup hintItems = root.findViewById(R.id.pdp_calendar_hint);
        if (calendarConstraints != null && calendarConstraints.getHintTitleToColor() != null
            ...
            hintItems.setVisibility(View.GONE);
        }
        return root;
    }
    ...
    private void startPickerFragment() {
        ...
        pickerFragment = headerToggleButton.isChecked()
