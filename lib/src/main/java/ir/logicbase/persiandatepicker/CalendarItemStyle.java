...
/**
 * Loads and applies {R.styleable#MaterialCalendarDay} attributes to {@link TextView}
 * instances.
 */
final class CalendarItemStyle {
     ...
     *
     * <p>The selection marker's size is defined by the {
     * R.styleable.MaterialCalendarItem#itemShapeAppearance} and {
    ...
    private static final int COLOR_INT_DEFAULT = -1;
    private static final String TEXT_COLOR_DEFAULT = "#FFFFFF";
    ...
    static CalendarItemStyle create(@NonNull Context context, @StyleRes int materialCalendarItemStyle) {
        return create(context, materialCalendarItemStyle, COLOR_INT_DEFAULT);
    }
    ...
    static CalendarItemStyle create(
        ...
        ColorStateList textColor;
        if (itemBackgroundColor != -1) {
            textColor = ColorStateList.valueOf(Color.parseColor(TEXT_COLOR_DEFAULT));
        } else {
    ...
    /**
     * Applies the { R.styleable#MaterialCalendarDay} style to the provided {@code item}
     */
