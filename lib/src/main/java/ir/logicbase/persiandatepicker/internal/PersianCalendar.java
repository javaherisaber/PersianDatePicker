package ir.logicbase.persiandatepicker.internal;
...
public class PersianCalendar extends Calendar {
    ...
    private static int[] ACTUAL_MAXIMUMS_MONTH = new int[]{31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 29};
    ...
    public static final String[] PERSIAN_MONTH = {"فروردین", "اردیبهشت", "خرداد", "تیر", "مرداد", "شهریور",
    ...
    public int getActualMaximum(int field) {
        switch (field) {
            case DAY_OF_MONTH: {
                ...
                if (month == PersianCalendar.ESFAND && converter.isJalaliLeapYear(this.get(YEAR))) {
                    return 30;
                } else {
                    return ACTUAL_MAXIMUMS_MONTH[month];
                }
            }
